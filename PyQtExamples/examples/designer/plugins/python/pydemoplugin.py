...
class PyDemoPlugin(QPyDesignerCustomWidgetPlugin):
    ...
    # tool tip.
    def toolTip(self):
        return "PyQtExamples demonstration widget"
    ...
    def domXml(self):
        return '<widget class="PyDemo" name="pyDemo">\n' \
               ...
               '  <string>PyQtExamples demonstration widget</string>\n' \
               ' </property>\n' \
               ' <property name="whatsThis" >\n' \
               '  <string>PyDemo is a demonstration custom widget written ' \
               'in Python using PyQtExamples.</string>\n' \
               ' </property>\n' \
               '</widget>\n'
